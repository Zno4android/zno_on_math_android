...
public final class SuccessMessageConstants {
    public static final String ADD_TEST_SUCCESS_ADD_TEST = "Тест додано";

    public static final String ADD_TEST_SUCCESS_EDIT_TEST = "Тест змінено";

    public static final String ADD_THEME_SUCCESS_ADD_THEME = "Тема успішно додана";
